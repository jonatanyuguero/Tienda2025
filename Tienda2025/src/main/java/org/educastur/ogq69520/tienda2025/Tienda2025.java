...
public class Tienda2025 implements Serializable{
   ...
   Scanner sc = new Scanner(System.in);
    ...
    public Tienda2025(ArrayList<Pedido> pedidos, HashMap<String, Articulo> articulos, HashMap<String, Cliente> clientes) {
    ...
    public void menuPedido(){
        ...
        do {
            ...
            System.out.println("2. Ver pedidos ordenados por importe");
            System.out.println("3. Ver pedidos ordenados por fecha");
            System.out.println("4. Ver pedidos con importe superior a un valor");
